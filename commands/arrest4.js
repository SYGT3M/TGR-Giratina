...
module.exports = {
    name: 'arrest4',
    aliases: 'arrest4hr',
    description: 'Arrest command exclusive to @Arrest Perms for arresting people who evade the passes.',
    cooldown: 5,
    usage: '<criminal>',
    execute(message, args) {
        ...
        let arrembed = new Discord.MessageEmbed()
            ...
            .setDescription("Stop! You have violated the Law! \nPay the court a fine or serve your sentence. \nYou must have a pass to say that!!\nYou will be <@&713490236780445706> for 4hrs to serve your sentence!")
            .setTimestamp()
        ...
        let logembed = new Discord.MessageEmbed()
            ...
            .setDescription(`<@${arrester.id}> used the +arrest4 command on <@${auser.id}> for 4 hours.\nPlease add a reason and necessary screenshots and/or links to the offence.`)
            ...
            .then(message => {
                setTimeout(function () {
                    if (auser.roles.cache.has(713490236780445706)) {
                        ...
                        auser.send(arrembed.setTitle("You have served your sentence well.").setDescription("You have served your sentence of 4 hours well. You are now free to leave. Move Along. Move Along."))
                    }
                }, 14400000);
            });
    }
